...
#define RF69_PIN_IRQ         13 // DIO0 connected to this pin: ESP32 GPIO 13
...
class DavisRFM69 {
  public:    
    ...
    void setHighPower(bool _isRFM69HW_HCW);
  ...
  protected:
    ...
    static volatile bool _isRFM69HW;
    static volatile int _powerLevel;
    static volatile int _irqFlags1;
    static volatile int _irqFlags2;
    ...
    void amIReady(void);
    void printIRQRegisters(void);
    void resetFIFO(void);
    void setHighPowerRegs(bool enable);
};
